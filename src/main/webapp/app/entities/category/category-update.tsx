...
export class CategoryUpdate extends React.Component<ICategoryUpdateProps, ICategoryUpdateState> {
  ...
  render() {
    ...
    const { image, imageContentType } = categoryEntity;

    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tdPortalApp.category.home.createOrEditLabel">
              <Translate contentKey="tdPortalApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
